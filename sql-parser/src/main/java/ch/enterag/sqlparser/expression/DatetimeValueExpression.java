...
public class DatetimeValueExpression
    ...
    public boolean isLocalTimeZone() {
        return _bLocalTimeZone;
    }

    public void setLocalTimeZone(boolean bLocalTimeZone) {
        _bLocalTimeZone = bLocalTimeZone;
    }
