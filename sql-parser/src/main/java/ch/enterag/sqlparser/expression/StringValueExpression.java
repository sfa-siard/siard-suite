...
public class StringValueExpression
    ...
    private class SveVisitor extends EnhancedSqlBaseVisitor<StringValueExpression> {
        ...
        public StringValueExpression visitStringValueExpression(SqlParser.StringValueExpressionContext ctx) {
            if ((ctx.CONCATENATION_OPERATOR() != null) && (ctx.stringValueExpression()
                                                              .size() == 2)) {
    ...
    public boolean isConcatenation() {
        return _bConcatenation;
    }

    public void setConcatenation(boolean bConcatenation) {
        _bConcatenation = bConcatenation;
    }
            ...
            if ((dt1 != null) && (dt2 != null)) {
                ...
                if ((pt1 != null) && (pt2 != null)) {
                    ...
                    if (pt1.getMultiplier() != null)
                        lLength1 = lLength1 * pt1.getMultiplier()
                                                 .getValue();
                    long lLength2 = pt2.getLength();
                    if (pt2.getMultiplier() != null)
                        lLength2 = lLength2 * pt2.getMultiplier()
                                                 .getValue();
                    ...
                    switch (pt1.getType()) {
                        ...
                        case NCHAR:
                            switch (pt2.getType()) {
                                ...
                                case XML:
                                    ...
                                    break;
                                default:
                                    throw new IllegalArgumentException("Unexpected data type for string value expression: " + pt2.getType()
                                                                                                                                 .getKeyword() + "!");
                            }
                            break;
                        case VARCHAR:
                        ...
                        case XML:
                            ...
                            break;
                        default:
                            throw new IllegalArgumentException("Unexpected data type for string value expresseion: " + pt1.getType()
                                                                                                                          .getKeyword() + "!");
                    }
                }
            }
