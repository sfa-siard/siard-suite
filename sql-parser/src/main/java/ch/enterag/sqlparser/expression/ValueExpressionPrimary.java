...
public class ValueExpressionPrimary
    ...
    private class VepVisitor extends EnhancedSqlBaseVisitor<ValueExpressionPrimary> {
        ...
        /**
         @Override public ValueExpressionPrimary visitColumnRef(SqlParser.ColumnRefContext ctx)
         {
        ...
        public ValueExpressionPrimary visitGroupingOp(SqlParser.GroupingOpContext ctx) {
            for (int i = 0; i < ctx.groupingOperation()
                                   .columnReference()
                                   .size(); i++) {
                IdChain idcColumnReference = new IdChain();
                setIdChain(ctx.groupingOperation()
                              .columnReference(i)
                              .identifierChain(), idcColumnReference);
        ...
        public ValueExpressionPrimary visitScalarSubq(SqlParser.ScalarSubqContext ctx) {
            ...
            getScalarSubq().parse(ctx.scalarSubquery()
                                     .queryExpression());
            return ValueExpressionPrimary.this;
        }
        ...
        public ValueExpressionPrimary visitGeneralizedMethodInvoc(SqlParser.GeneralizedMethodInvocContext ctx) {
            setMethodQualifier(getSqlFactory().newValueExpressionPrimary());
            getMethodQualifier().parse(ctx.generalizedInvocation()
                                          .valueExpressionPrimary());
            setDataType(getSqlFactory().newDataType());
            getDataType().parse(ctx.generalizedInvocation()
                                   .dataType());
            setIdentifier(ctx.generalizedInvocation()
                             .methodName()
                             .IDENTIFIER(), getMethodName());
            if (ctx.generalizedInvocation()
                   .sqlArgumentList() != null)
                getSqlArgumentList(ctx.generalizedInvocation()
                                      .sqlArgumentList(), getSqlArguments());
            return ValueExpressionPrimary.this;
        }

        @Override
        public ValueExpressionPrimary visitStaticMethodInvoc(SqlParser.StaticMethodInvocContext ctx) {
            setUdtName(ctx.staticMethodInvocation()
                          .udtName(), getUdtName());
            setIdentifier(ctx.staticMethodInvocation()
                             .methodName()
                             .IDENTIFIER(), getMethodName());
            if (ctx.staticMethodInvocation()
                   .sqlArgumentList() != null)
                getSqlArgumentList(ctx.staticMethodInvocation()
                                      .sqlArgumentList(), getSqlArguments());
            return ValueExpressionPrimary.this;
        }
        ...
        public ValueExpressionPrimary visitNewSpec(SqlParser.NewSpecContext ctx) {
            setNew(true);
            setRoutineName(ctx.newSpecification()
                              .routineInvocation()
                              .routineName(), getRoutineName());
            if (ctx.newSpecification()
                   .routineInvocation()
                   .sqlArgumentList() != null)
                getSqlArgumentList(ctx.newSpecification()
                                      .routineInvocation()
                                      .sqlArgumentList(), getSqlArguments());
            return ValueExpressionPrimary.this;
        }
        ...
        public ValueExpressionPrimary visitReferenceRes(SqlParser.ReferenceResContext ctx) {
            ...
            getReferenceResolution().parse(ctx.referenceResolution()
                                              .valueExpressionPrimary());
            return ValueExpressionPrimary.this;
        }
        ...
        public ValueExpressionPrimary visitArrayValueConstruct(SqlParser.ArrayValueConstructContext ctx) {
            ...
            if (ctx.arrayValueConstructor()
                   .queryExpression() != null) {
                setQueryExpression(getSqlFactory().newQueryExpression());
                getQueryExpression().parse(ctx.arrayValueConstructor()
                                              .queryExpression());
                if (ctx.arrayValueConstructor()
                       .sortSpecificationList() != null) {
                    for (int i = 0; i < ctx.arrayValueConstructor()
                                           .sortSpecificationList()
                                           .sortSpecification()
                                           .size(); i++) {
                        SortSpecification ss = getSqlFactory().newSortSpecification();
                        ss.parse(ctx.arrayValueConstructor()
                                    .sortSpecificationList()
                                    .sortSpecification(i));
                ...
                getCollectionValueComponentList(ctx.arrayValueConstructor()
                                                   .valueExpression());
            return ValueExpressionPrimary.this;
        }
        ...
        public ValueExpressionPrimary visitMultisetValueConstruct(SqlParser.MultisetValueConstructContext ctx) {
            ...
            if (ctx.multisetValueConstructor()
                   .TABLE() != null)
                setTableMultisetValueConstructor(true);
            if (ctx.multisetValueConstructor()
                   .queryExpression() != null) {
                setQueryExpression(getSqlFactory().newQueryExpression());
                getQueryExpression().parse(ctx.multisetValueConstructor()
                                              .queryExpression());
            } else
                getCollectionValueComponentList(ctx.multisetValueConstructor()
                                                   .valueExpression());
            return ValueExpressionPrimary.this;
        }
        ...
        public ValueExpressionPrimary visitMultisetElementRef(SqlParser.MultisetElementRefContext ctx) {
            ...
            getMultisetValueExpression().parse(ctx.multisetElementReference()
        ...
        public ValueExpressionPrimary visitRoutineInvoc(SqlParser.RoutineInvocContext ctx) {
            setRoutineName(ctx.routineInvocation()
                              .routineName(), getRoutineName());
            if (ctx.routineInvocation()
                   .sqlArgumentList() != null)
                getSqlArgumentList(ctx.routineInvocation()
                                      .sqlArgumentList(), getSqlArguments());
            return ValueExpressionPrimary.this;
        }
        ...
        public ValueExpressionPrimary visitNextValueExp(SqlParser.NextValueExpContext ctx) {
            setSequenceName(ctx.nextValueExpression()
    ...
    public boolean isSqlArgumentList() {
        return _bSqlArgumentList;
    }

    public void setSqlArgumentList(boolean bSqlArgumentList) {
        _bSqlArgumentList = bSqlArgumentList;
    }
    ...
    public Identifier getAttributeOrMethodName() {
        return _idAttributeOrMethodName;
    }

    private void setAttributeOrMethodName(Identifier idAttributeOrMethodName) {
        _idAttributeOrMethodName = idAttributeOrMethodName;
    }
    ...
    public boolean isArrayValueConstructor() {
        return _bArrayValueConstructor;
    }

    public void setArrayValueConstructor(boolean bArrayValueConstructor) {
        _bArrayValueConstructor = bArrayValueConstructor;
    }
    ...
    public List<ValueExpression> getCollectionValueComponents() {
        return _listCollectionValueComponents;
    }

    private void setCollectionValueComponents(List<ValueExpression> listCollectionValueComponents) {
        _listCollectionValueComponents = listCollectionValueComponents;
    }
    ...
    protected String formatCollectionValueComponents() {
        ...
        if (getCollectionValueComponents().size() > 0) {
            ...
            for (int i = 0; i < getCollectionValueComponents().size(); i++) {
                if (i > 0)
                    s = s + sCOMMA + sSP;
                s = s + getCollectionValueComponents().get(i)
                                                      .format();
            }
            s = s + sRIGHT_BRACKET;
        }
    ...
    public String format() {
        ...
        if (getUnsignedLit() != null)
            ...
            for (int i = 0; i < getGroupingOp().size(); i++) {
                ...
                sExpression = sExpression + getGroupingOp().get(i)
                                                           .format();
            }
            ...
            if (getQueryExpression() != null) {
                ...
                if (getSortSpecifications().size() > 0) {
                    ...
                    for (int i = 0; i < getSortSpecifications().size(); i++) {
                        if (i > 0)
                            sExpression = sExpression + sCOMMA + sSP;
                        sExpression = sExpression + getSortSpecifications().get(i)
                                                                           .format();
                    }
                }
                sExpression = sExpression + sRIGHT_PAREN;
