...
public class TablePrimary
    ...
    public boolean isWithOrdinality() {
        return _bWithOrdinality;
    }

    public void setWithOrdinality(boolean bWithOrdinality) {
        _bWithOrdinality = bWithOrdinality;
    }
