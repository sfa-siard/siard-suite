...
public class AggregateFunction
    ...
    public List<SortSpecification> getWithinGroupSortSpecifications() {
        return _listWithinGroupSortSpecifications;
    }

    private void setWithinGroupSortSpecifications(List<SortSpecification> listWithinGroupSortSpecifications) {
        _listWithinGroupSortSpecifications = listWithinGroupSortSpecifications;
    }
        ...
        if (isCountFunction())
            ...
            if (getRankFunction() != null) {
                ...
                for (int i = 0; i < getRankArguments().size(); i++) {
                    ...
                    sExpression = sExpression + getRankArguments().get(i)
                                                                  .format();
                }
            ...
            if (getWithinGroupSortSpecifications().size() > 0) {
                ...
                for (int i = 0; i < getWithinGroupSortSpecifications().size(); i++) {
                    if (i > 0)
                        sExpression = sExpression + sCOMMA + sSP;
                    sExpression = sExpression + getWithinGroupSortSpecifications().get(i)
                                                                                  .format();
                }
                sExpression = sExpression + sRIGHT_PAREN;
            }
