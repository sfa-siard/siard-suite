        ...
        if ((getFirstOperand() != null) && (getSecondOperand() != null)) {
            ...
            if ((dt1 != null) && (dt2 != null)) {
                ...
                if ((pt1 != null) && (pt2 != null)) {
                    int ip1 = dt1.getPredefinedType()
                                 .getPrecision();
                    int is1 = dt1.getPredefinedType()
                                 .getScale();
                    int ip2 = dt2.getPredefinedType()
                                 .getPrecision();
                    int is2 = dt2.getPredefinedType()
                                 .getScale();
                    ...
                    switch (pt1.getType()) {
                        ...
                        case NUMERIC:
                            switch (pt2.getType()) {
                                ...
                                case SMALLINT:
                                    ...
                                    break;
                                default:
                                    throw new IllegalArgumentException("Unexpected data type for numeric value expression: " + pt2.getType()
                                                                                                                                  .getKeyword() + "!");
                            }
                            break;
                        case BIGINT:
                        ...
                        case SMALLINT:
                            ...
                            break;
                        default:
                            throw new IllegalArgumentException("Unexpected data type for numeric value expression: " + pt1.getType()
                                                                                                                          .getKeyword() + "!");
                    }
                    if (ip1 > ip2)
                        dt.getPredefinedType()
                          .setPrecision(ip1);
                    if (is1 > is2)
                        dt.getPredefinedType()
                          .setScale(is1);
