    ...
    public String format() {
        ...
        if (getWithElements().size() > 0) {
            ...
            for (int i = 0; i < getWithElements().size(); i++) {
                ...
                sExpression = sExpression + getWithElements().get(i)
                                                             .format();
            }
