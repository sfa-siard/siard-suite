    ...
    public String format() {
        ...
        if (getColumnNames().isSet())
            ...
            for (int i = 0; i < getViewElements().size(); i++) {
                ...
                sStatement = sStatement + sSP + getViewElements().get(i)
                                                                 .format();
            }
