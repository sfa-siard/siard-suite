...
public class SetTarget
    ...
    private class StVisitor extends EnhancedSqlBaseVisitor<SetTarget> {
        ...
        public SetTarget visitSetTarget(SqlParser.SetTargetContext ctx) {
            ...
            if ((ctx.methodName() == null) && (ctx.updateTarget()
                                                  .size() == 1)) {
