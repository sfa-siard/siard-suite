...
public class InsertStatementTester {
    ...
    public void testConstructor() {
        ...
        // System.out.println(_is.format());
        assertEquals("Invalid number of row value constructors: ", 1, _is.getValues()
                                                                         .size());
        assertEquals("Invalid number of update sources: ", 3, _is.getValues()
                                                                 .get(0)
                                                                 .getUpdateSources()
                                                                 .size());
    ...
    public void testConstructor2() {
        ...
        assertEquals("Invalid number of row value constructors: ", 1, _is.getValues()
                                                                         .size());
        assertEquals("Invalid number of update sources: ", 22, _is.getValues()
                                                                  .get(0)
                                                                  .getUpdateSources()
                                                                  .size());
        System.out.println(_is.format());
