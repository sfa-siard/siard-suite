...
public class SqlStatementTester {
    ...
    public void testQueryEvaluation() {
        ...
        System.out.println("Tables: " + String.valueOf(qs.getTableReferences()
                                                         .size()));
        System.out.println("Select sublists: " + String.valueOf(qs.getSelectSublists()
                                                                  .size()));

        TablePrimary tp1 = qs.getTableReferences()
                             .get(0)
                             .getTablePrimary();
        System.out.println("Table 0: " + tp1.getTableName()
                                            .format());
        TablePrimary tp2 = qs.getTableReferences()
                             .get(1)
                             .getTablePrimary();
        System.out.println("Table 1: " + tp2.getTableName()
                                            .format() + " AS " + tp2.getCorrelationName()
                                                                    .format());

        SelectSublist ss1 = qs.getSelectSublists()
                              .get(0);
        NumericValueExpression nve = ss1.getValueExpression()
                                        .getCommonValueExpression()
                                        .getNumericValueExpression();
        System.out.println("Select 0 numeric value, operator: " + nve.getAdditiveOperator()
                                                                     .getKeywords());
        NumericValueExpression nve1 = nve.getFirstOperand();
        ValueExpressionPrimary vep_0_0 = nve1.getValueExpressionPrimary();
        BigDecimal bd = vep_0_0.getUnsignedLit()
                               .getExact();
        ...
        IdChain idc0 = vep_0_1.getGeneralValueSpecification()
                              .getColumnOrParameter();
        System.out.println("Select 0, second operand: " + idc0.format());

        SelectSublist ss2 = qs.getSelectSublists()
                              .get(1);
        StringValueExpression sve = ss2.getValueExpression()
                                       .getCommonValueExpression()
        ...
        String s = vep_1_0.getUnsignedLit()
                          .getCharacterString();
        ...
        IdChain idc1 = vep_1_1.getGeneralValueSpecification()
                              .getColumnOrParameter();
        System.out.println("Select 1, second operand: " + idc1.format());

        SelectSublist ss3 = qs.getSelectSublists()
                              .get(2);
        ValueExpressionPrimary vep_2 = ss3.getValueExpression()
                                          .getCommonValueExpression()
                                          .getValueExpressionPrimary();
        IdChain idc2 = vep_2.getGeneralValueSpecification()
                            .getColumnOrParameter();
        System.out.println("Select 2: " + idc2.format());

        BooleanPrimary bp = qs.getWhereCondition()
                              .getBooleanPrimary();
        System.out.println("Where condition: " + bp.getCompOp()
                                                   .getKeywords());
        RowValuePredicand rvp1 = bp.getRowValuePredicand();
        ValueExpressionPrimary vep_w_0 = rvp1.getCommonValueExpression()
                                             .getValueExpressionPrimary();
        IdChain idcw = vep_w_0.getGeneralValueSpecification()
                              .getColumnOrParameter();
        System.out.println("Where condition first operand: " + idcw.format());
        RowValuePredicand rvp2 = bp.getSecondRowValuePredicand();
        ValueExpressionPrimary vep_w_1 = rvp2.getCommonValueExpression()
                                             .getValueExpressionPrimary();
        BigDecimal bdw = vep_w_1.getUnsignedLit()
                                .getExact();
        ...
        System.out.println("1: " + String.valueOf(ss1.evaluate(_ss) + " " + ss1.getDataType(_ss)
                                                                               .format())); // 34
        System.out.println("2: " + String.valueOf(ss2.evaluate(_ss) + " " + ss2.getDataType(_ss)
                                                                               .format())); // abcAText
        System.out.println("3: " + String.valueOf(ss3.evaluate(_ss) + " " + ss3.getDataType(_ss)
                                                                               .format())); // -18
        System.out.println("W: " + String.valueOf(qs.getWhereCondition()
