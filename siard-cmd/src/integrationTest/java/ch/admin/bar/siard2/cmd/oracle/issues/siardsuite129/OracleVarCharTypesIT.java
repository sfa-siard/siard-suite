...
public class OracleVarCharTypesIT {
    ...
    public OracleContainer db = new OracleContainer("gvenzl/oracle-xe:21-slim-faststart")
            ...
            .withCopyFileToContainer(
                    MountableFile.forHostPath(TestResourcesResolver.resolve(SqlScripts.Oracle.SIARDSUITE_129_VARCHAR)
                                                                   .toPath()),
    ...
    public void downloadArchive() throws SQLException, IOException, ClassNotFoundException {
        ...
        val columnText2 = metadataExplorer.findByColumnId(QualifiedColumnId.builder()
                                                                           ...
                                                                           .build());
        Assertions.assertThat(columnText2.getType())
                  .contains(Id.of("VARCHAR(1)"));
        Assertions.assertThat(columnText2.getTypeOriginal())
                  .contains(Id.of("VARCHAR2(1)"));
        ...
        val columnText3 = metadataExplorer.findByColumnId(QualifiedColumnId.builder()
                                                                           ...
                                                                           .build());
        Assertions.assertThat(columnText3.getType())
                  .contains(Id.of("VARCHAR(255)"));
        Assertions.assertThat(columnText3.getTypeOriginal())
                  .contains(Id.of("VARCHAR2(255)"));
        ...
        val columnText4 = metadataExplorer.findByColumnId(QualifiedColumnId.builder()
                                                                           ...
                                                                           .build());
        Assertions.assertThat(columnText4.getType())
                  .contains(Id.of("VARCHAR(4000)"));
        Assertions.assertThat(columnText4.getTypeOriginal())
                  .contains(Id.of("VARCHAR2(4000)"));
        ...
        val columnDayOfYear = metadataExplorer.findByColumnId(QualifiedColumnId.builder()
                                                                               ...
                                                                               .build());
        Assertions.assertThat(columnDayOfYear.getType())
                  .contains(Id.of("SMALLINT"));
        Assertions.assertThat(columnDayOfYear.getTypeOriginal())
                  .contains(Id.of("NUMBER(3,0)"));
        ...
        val columnWeightInKg = metadataExplorer.findByColumnId(QualifiedColumnId.builder()
                                                                                ...
                                                                                .build());
        Assertions.assertThat(columnWeightInKg.getType())
                  .contains(Id.of("DEC(3, 2)"));
        Assertions.assertThat(columnWeightInKg.getTypeOriginal())
                  .contains(Id.of("NUMBER(3,2)"));
    }
}
