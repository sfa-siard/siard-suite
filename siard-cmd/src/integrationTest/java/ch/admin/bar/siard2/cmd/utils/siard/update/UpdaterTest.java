...
public class UpdaterTest {
    ...
    public void applyUpdates_onChild_expectAppliedUpdate() {
        ...
        // then
        val expected = DUMMY_DATA.toBuilder()
                                 .singleChild(DUMMY_DATA.getSingleChild()
                                                        .toBuilder()
                                                        .name("UPDATED_" + DUMMY_DATA.getSingleChild()
                                                                                     .getName())
                                                        .build())
                                 .build();
        ...
        val expected = DUMMY_DATA.toBuilder()
                                 ...
                                 .singleChild(DUMMY_DATA.getSingleChild()
                                                        ...
                                                        .singleChild(DUMMY_DATA.getSingleChild()
                                                                               ...
                                                                               .build())
                                                        .build())
                                 .multipleChildren(DUMMY_DATA.getMultipleChildren()
                                                             .stream()
    ...
    public void applyUpdates_generalStrings_expectAppliedUpdate() {
        ...
        // then
        val expected = DUMMY_DATA.toBuilder()
                                 .name(DUMMY_DATA.getName()
                                                 .toUpperCase())
                                 .singleChild(DUMMY_DATA.getSingleChild()
                                                        .toBuilder()
                                                        .name(DUMMY_DATA.getSingleChild()
                                                                        .getName()
                                                                        .toUpperCase())
                                                        .singleChild(DUMMY_DATA.getSingleChild()
                                                                               .getSingleChild()
