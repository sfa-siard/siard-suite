...
public class MySqlDefaultDataTypes {
    ...
    public static void executeTest(SiardArchivesHandler siardArchivesHandler, String jdbcUrl) {
        ...
        // string types
        assertionsHelper.assertThat(COLUMN_CHAR)
                        .containsExactly("abc");

        assertionsHelper.assertThat(COLUMN_CHAR)
                        .containsExactly("abc");
        assertionsHelper.assertThat(COLUMN_VARCHAR)
                        .containsExactly("varchar example");
        assertionsHelper.assertThat(COLUMN_TINYTEXT)
                        .containsExactly("tinytext example");
...
//        assertionsHelper.testThat(COLUMN_LONGTEXT).containsExactly("longtext example");
        ...
        assertionsHelper.assertThat(COLUMN_ENUM)
                        .containsExactly("value1");
        assertionsHelper.assertThat(COLUMN_SET)
                        .containsExactly("option1,option2");
        assertionsHelper.assertThat(COLUMN_BINARY)
                        .containsExactly(toHex("binary"));
        assertionsHelper.assertThat(COLUMN_VARBINARY)
                        .containsExactly(toHex("varbinary"));

        // numeric types
        assertionsHelper.assertThat(COLUMN_BIT)
                        .containsExactly("true");
        assertionsHelper.assertThat(COLUMN_TINYINT)
                        .containsExactly("42");
        assertionsHelper.assertThat(COLUMN_SMALLINT)
                        .containsExactly("32767");
        assertionsHelper.assertThat(COLUMN_MEDIUMINT)
                        .containsExactly("8388607");
        assertionsHelper.assertThat(COLUMN_INT)
                        .containsExactly("2147483647");
        assertionsHelper.assertThat(COLUMN_BIGINT)
                        .containsExactly("9223372036854775807");
        assertionsHelper.assertThat(COLUMN_DECIMAL)
...
//        assertionsHelper.assertThat(COLUMN_FLOAT).containsExactly("123.45"); FIXME rounding errors (123.44999694824219)
        assertionsHelper.assertThat(COLUMN_FLOAT)
                        .isPresent();
        assertionsHelper.assertThat(COLUMN_DOUBLE)
                        .containsExactly("123.45");
        assertionsHelper.assertThat(COLUMN_BOOLEAN)
                        .containsExactly("1");

        // date/time types
        assertionsHelper.assertThat(COLUMN_DATE)
                        .containsExactly("2022-01-01");
//        assertionsHelper.assertThat(COLUMN_DATETIME).containsExactly("2022-01-01T12:34:56Z"); FIXME timezone shift
        assertionsHelper.assertThat(COLUMN_DATETIME)
                        .isPresent();
//        assertionsHelper.assertThat(COLUMN_TIMESTAMP).containsExactly("2022-01-01T12:34:56Z");  FIXME timezone shift
        assertionsHelper.assertThat(COLUMN_TIMESTAMP)
                        .isPresent();
//        assertionsHelper.assertThat(COLUMN_TIME).containsExactly("12:34:56Z");  FIXME timezone shift
        assertionsHelper.assertThat(COLUMN_TIME)
                        .isPresent();
        assertionsHelper.assertThat(COLUMN_YEAR)
                        .containsExactly("2022");

        // LOB types
        assertionsHelper.assertThat(COLUMN_TINYBLOB)
                        .containsExactly(toHex("tinyblob data"));
