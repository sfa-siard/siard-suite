...
class ValidationPropertiesTest {
    ...
    void shouldValidateAllProperties() {
        ...
        Assertions.assertEquals(msg1.textProperty().get(), "test.validationmsg1");
        Assertions.assertEquals(msg2.textProperty().get(), "test.validationmsg2");
    }
    ...
    void shouldReturnTrueWhenAllPropertiesAreSet() {
        ...
        Assertions.assertEquals(msg1.textProperty().get(), "");
        Assertions.assertEquals(msg2.textProperty().get(), "");
    }
