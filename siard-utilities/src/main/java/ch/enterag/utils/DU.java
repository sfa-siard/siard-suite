...
public class DU {
    ...
    static {
        ...
        try {
            ...
            System.err.println(pe.getClass()
    ...
    public XMLGregorianCalendar toXmlGregorianCalendar(String s)
        ...
        if (gc != null) {
            try {
                ...
                System.err.println(dtce.getClass()
    ...
    public java.sql.Time fromXsTime(String s)
        ...
        if (iDecimalPoint >= 0) {
            ...
            if (sDecimals.length() < 3)
                sDecimals = String.format("%1$-3s", sDecimals)
                                  .replace(" ", "0");
    ...
    public java.sql.Timestamp fromXsDateTime(String s)
        ...
        if (iDecimalPoint >= 0) {
            ...
            /* right padding with "0"s */
            sDecimals = String.format("%1$-9s", sDecimals)
                              .replace(" ", "0");
            ;
