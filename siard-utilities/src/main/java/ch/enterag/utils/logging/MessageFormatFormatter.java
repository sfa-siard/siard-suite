...
public class MessageFormatFormatter extends Formatter {
    ...
    public String format(LogRecord record) {
        ...
        arguments[1] = Integer.valueOf(record.getLevel()
                                             .intValue());
        arguments[2] = Thread.currentThread()
                             .getName();
        ...
        String sFormat = LogManager.getLogManager()
                                   .getProperty(MessageFormatFormatter.class.getName() + ".pattern");
