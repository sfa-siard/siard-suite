...
public abstract class BaseArrayTester {
    ...
    public void testGetBaseTypeName() {
        enter();
        try {
            System.out.println(_array.getBaseTypeName());
    ...
    public void testGetBaseType() {
        enter();
        try {
            System.out.println(String.valueOf(_array.getBaseType()));
        } catch (SQLFeatureNotSupportedException sfnse) {
            printExceptionMessage(sfnse);
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testGetResultSet_Long_Int() {
        enter();
        try {
            print(_array.getResultSet(1l, 2));
        } catch (SQLFeatureNotSupportedException sfnse) {
            printExceptionMessage(sfnse);
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
