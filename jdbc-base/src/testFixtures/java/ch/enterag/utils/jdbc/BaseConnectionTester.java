...
public abstract class BaseConnectionTester {
    ...
    public void testSetTypeMap() {
        enter();
        try {
            _conn.setTypeMap(new HashMap<String, Class<?>>());
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testSetSavepoint_String() {
        enter();
        try {
            _conn.setSavepoint("TEST_SAVEPOINT");
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testPrepareStatement_String_Int() {
        enter();
        try {
            _conn.prepareStatement(_sSQL, Statement.NO_GENERATED_KEYS);
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testPrepareStatement_String_AInt() {
        enter();
        try {
            _conn.prepareStatement(_sSQL, new int[]{1, 2});
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testPrepareStatement_String_AString() {
        enter();
        try {
            _conn.prepareStatement(_sSQL, new String[]{"COL_A", "COL_B"});
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testCreateStruct() {
        enter();
        try {
            _conn.createStruct("TEST_SCHEMA.TEST_STRUCT_TYPE", new String[]{"a", "b", "c"});
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
