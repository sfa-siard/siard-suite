...
public abstract class BaseDatabaseMetaDataTester {
    ...
    public BaseDatabaseMetaData getBaseDatabaseMetaData() {
        return (BaseDatabaseMetaData) _dmd;
    }

    /* setUp must create the database meta data and call this method */
    protected void setDatabaseMetaData(DatabaseMetaData dmd) {
        _dmd = dmd;
    }
    ...
    public void testAllProceduresAreCallable() {
        enter();
        try {
            println(String.valueOf(_dmd.allProceduresAreCallable()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testAllTablesAreSelectable() {
        enter();
        try {
            println(String.valueOf(_dmd.allTablesAreSelectable()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetURL() {
        enter();
        try {
            println(String.valueOf(_dmd.getURL()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetUserName() {
        enter();
        try {
            println(String.valueOf(_dmd.getUserName()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testIsReadOnly() {
        enter();
        try {
            println(String.valueOf(_dmd.isReadOnly()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testNullsAreSortedHigh() {
        enter();
        try {
            println(String.valueOf(_dmd.nullsAreSortedHigh()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testNullsAreSortedLow() {
        enter();
        try {
            println(String.valueOf(_dmd.nullsAreSortedLow()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testNullsAreSortedAtStart() {
        enter();
        try {
            println(String.valueOf(_dmd.nullsAreSortedAtStart()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testNullsAreSortedAtEnd() {
        enter();
        try {
            println(String.valueOf(_dmd.nullsAreSortedAtEnd()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetDatabaseProductName() {
        enter();
        try {
            println(String.valueOf(_dmd.getDatabaseProductName()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetDatabaseProductVersion() {
        enter();
        try {
            println(String.valueOf(_dmd.getDatabaseProductVersion()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetDriverName() {
        enter();
        try {
            println("Wrapped " + String.valueOf(_dmd.getDriverName()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetDriverVersion() {
        enter();
        try {
            println(String.valueOf(_dmd.getDriverVersion()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testUsesLocalFiles() {
        enter();
        try {
            println(String.valueOf(_dmd.usesLocalFiles()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsMixedCaseIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsMixedCaseIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testStoresUpperCaseIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.storesUpperCaseIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testStoresLowerCaseIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.storesLowerCaseIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testStoresMixedCaseIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.storesMixedCaseIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsMixedCaseQuotedIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsMixedCaseQuotedIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testStoresUpperCaseQuotedIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.storesUpperCaseQuotedIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testStoresLowerCaseQuotedIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.storesLowerCaseQuotedIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testStoresMixedCaseQuotedIdentifiers() {
        enter();
        try {
            println(String.valueOf(_dmd.storesMixedCaseQuotedIdentifiers()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetIdentifierQuoteString() {
        enter();
        try {
            println(String.valueOf(_dmd.getIdentifierQuoteString()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetSQLKeywords() {
        enter();
        try {
            println(String.valueOf(_dmd.getSQLKeywords()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetNumericFunctions() {
        enter();
        try {
            println(String.valueOf(_dmd.getNumericFunctions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetStringFunctions() {
        enter();
        try {
            println(String.valueOf(_dmd.getStringFunctions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetSystemFunctions() {
        enter();
        try {
            println(String.valueOf(_dmd.getSystemFunctions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetTimeDateFunctions() {
        enter();
        try {
            println(String.valueOf(_dmd.getTimeDateFunctions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetSearchStringEscape() {
        enter();
        try {
            println(String.valueOf(_dmd.getSearchStringEscape()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetExtraNameCharacters() {
        enter();
        try {
            println(String.valueOf(_dmd.getExtraNameCharacters()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsAlterTableWithAddColumn() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsAlterTableWithAddColumn()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsAlterTableWithDropColumn() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsAlterTableWithDropColumn()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsColumnAliasing() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsColumnAliasing()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testNullPlusNonNullIsNull() {
        enter();
        try {
            println(String.valueOf(_dmd.nullPlusNonNullIsNull()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsConvert() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsConvert()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsConvert_Int_Int() {
        ...
        try {
            ...
            for (int i = 0; i < listTypes.size(); i++) {
                int iFromType = listTypes.get(i)
                                         .intValue();
                for (int k = 0; k < listTypes.size(); k++) {
                    int iToType = listTypes.get(k)
                                           .intValue();
    ...
    public void testSupportsTableCorrelationNames() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsTableCorrelationNames()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsDifferentTableCorrelationNames() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsDifferentTableCorrelationNames()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsExpressionsInOrderBy() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsExpressionsInOrderBy()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsOrderByUnrelated() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsOrderByUnrelated()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsGroupBy() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsGroupBy()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsGroupByUnrelated() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsGroupByUnrelated()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsGroupByBeyondSelect() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsGroupByBeyondSelect()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsLikeEscapeClause() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsLikeEscapeClause()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsMultipleResultSets() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsMultipleResultSets()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsMultipleTransactions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsMultipleTransactions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsNonNullableColumns() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsNonNullableColumns()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsMinimumSQLGrammar() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsMinimumSQLGrammar()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsCoreSQLGrammar() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsCoreSQLGrammar()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsExtendedSQLGrammar() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsExtendedSQLGrammar()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsANSI92EntryLevelSQL() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsANSI92EntryLevelSQL()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsANSI92IntermediateSQL() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsANSI92IntermediateSQL()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsANSI92FullSQL() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsANSI92FullSQL()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsIntegrityEnhancementFacility() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsIntegrityEnhancementFacility()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsOuterJoins() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsOuterJoins()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsFullOuterJoins() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsFullOuterJoins()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsLimitedOuterJoins() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsLimitedOuterJoins()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetSchemaTerm() {
        enter();
        try {
            println(String.valueOf(_dmd.getSchemaTerm()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetProcedureTerm() {
        enter();
        try {
            println(String.valueOf(_dmd.getProcedureTerm()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetCatalogTerm() {
        enter();
        try {
            println(String.valueOf(_dmd.getCatalogTerm()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testIsCatalogAtStart() {
        enter();
        try {
            println(String.valueOf(_dmd.isCatalogAtStart()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetCatalogSeparator() {
        enter();
        try {
            println(String.valueOf(_dmd.getCatalogSeparator()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSchemasInDataManipulation() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSchemasInDataManipulation()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSchemasInProcedureCalls() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSchemasInProcedureCalls()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSchemasInTableDefinitions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSchemasInTableDefinitions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSchemasInIndexDefinitions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSchemasInIndexDefinitions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSchemasInPrivilegeDefinitions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSchemasInPrivilegeDefinitions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsCatalogsInDataManipulation() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsCatalogsInDataManipulation()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsCatalogsInProcedureCalls() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsCatalogsInProcedureCalls()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsCatalogsInTableDefinitions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsCatalogsInTableDefinitions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsCatalogsInIndexDefinitions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsCatalogsInIndexDefinitions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsCatalogsInPrivilegeDefinitions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsCatalogsInPrivilegeDefinitions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsPositionedDelete() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsPositionedDelete()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsPositionedUpdate() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsPositionedUpdate()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSelectForUpdate() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSelectForUpdate()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsStoredProcedures() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsStoredProcedures()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSubqueriesInComparisons() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSubqueriesInComparisons()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSubqueriesInExists() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSubqueriesInExists()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSubqueriesInIns() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSubqueriesInIns()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSubqueriesInQuantifieds() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSubqueriesInQuantifieds()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsCorrelatedSubqueries() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsCorrelatedSubqueries()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsUnion() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsUnion()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsUnionAll() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsUnionAll()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsOpenCursorsAcrossCommit() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsOpenCursorsAcrossCommit()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsOpenCursorsAcrossRollback() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsOpenCursorsAcrossRollback()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsOpenStatementsAcrossCommit() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsOpenStatementsAcrossCommit()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsOpenStatementsAcrossRollback() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsOpenStatementsAcrossRollback()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxBinaryLiteralLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxBinaryLiteralLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxCharLiteralLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxCharLiteralLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxColumnNameLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxColumnNameLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxColumnsInGroupBy() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxColumnsInGroupBy()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxColumnsInIndex() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxColumnsInIndex()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxColumnsInOrderBy() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxColumnsInOrderBy()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxColumnsInSelect() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxColumnsInSelect()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxColumnsInTable() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxColumnsInTable()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxConnections() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxConnections()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxCursorNameLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxCursorNameLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxIndexLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxIndexLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxSchemaNameLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxSchemaNameLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxProcedureNameLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxProcedureNameLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxCatalogNameLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxCatalogNameLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxRowSize() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxRowSize()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testDoesMaxRowSizeIncludeBlobs() {
        enter();
        try {
            println(String.valueOf(_dmd.doesMaxRowSizeIncludeBlobs()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxStatementLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxStatementLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxStatements() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxStatements()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxTableNameLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxTableNameLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxTablesInSelect() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxTablesInSelect()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetMaxUserNameLength() {
        enter();
        try {
            println(String.valueOf(_dmd.getMaxUserNameLength()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetDefaultTransactionIsolation() {
        enter();
        try {
            println(String.valueOf(_dmd.getDefaultTransactionIsolation()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsTransactions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsTransactions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsDataDefinitionAndDataManipulationTransactions() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsDataDefinitionAndDataManipulationTransactions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsDataManipulationTransactionsOnly() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsDataManipulationTransactionsOnly()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testDataDefinitionCausesTransactionCommit() {
        enter();
        try {
            println(String.valueOf(_dmd.dataDefinitionCausesTransactionCommit()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testDataDefinitionIgnoredInTransactions() {
        enter();
        try {
            println(String.valueOf(_dmd.dataDefinitionIgnoredInTransactions()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetProcedures() {
        enter();
        try {
            print(_dmd.getProcedures(null, null, "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetProcedureColumns() {
        enter();
        try {
            print(_dmd.getProcedureColumns(null, null, "%", "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetTables() {
        enter();
        try {
            print(_dmd.getTables(null, null, "%", null));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetColumns() {
        enter();
        try {
            print(_dmd.getColumns(null, null, "%", "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetColumnPrivileges() {
        enter();
        try {
            print(_dmd.getColumnPrivileges(null, null, "%", "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetTablePrivileges() {
        enter();
        try {
            print(_dmd.getTablePrivileges(null, null, "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetBestRowIdentifier() {
        enter();
        try {
            print(_dmd.getBestRowIdentifier(null, null, "%", DatabaseMetaData.bestRowUnknown, true));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetVersionColumns() {
        enter();
        try {
            print(_dmd.getVersionColumns(null, null, "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetPrimaryKeys() {
        enter();
        try {
            print(_dmd.getPrimaryKeys(null, null, "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetImportedKeys() {
        enter();
        try {
            print(_dmd.getImportedKeys(null, null, "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetExportedKeys() {
        enter();
        try {
            print(_dmd.getExportedKeys(null, null, "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetCrossReference() {
        enter();
        try {
            print(_dmd.getCrossReference(null, null, "%", null, null, "%"));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetIndexInfo() {
        enter();
        try {
            print(_dmd.getIndexInfo(null, null, "%", false, false));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsBatchUpdates() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsBatchUpdates()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetUDTs() {
        enter();
        try {
            print(_dmd.getUDTs(null, null, "%", null));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsSavepoints() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsSavepoints()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsNamedParameters() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsNamedParameters()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsMultipleOpenResults() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsMultipleOpenResults()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsGetGeneratedKeys() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsGetGeneratedKeys()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetSuperTypes() {
        enter();
        try {
            print(_dmd.getSuperTypes(null, null, "%"));
    ...
    public void testGetSuperTables() {
        enter();
        try {
            print(_dmd.getSuperTables(null, null, "%"));
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testGetAttributes() {
        enter();
        try {
            print(_dmd.getAttributes(null, null, "%", "%"));
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testSupportsResultSetHoldability() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsResultSetHoldability(ResultSet.HOLD_CURSORS_OVER_COMMIT)) + ", " + String.valueOf(_dmd.supportsResultSetHoldability(ResultSet.CLOSE_CURSORS_AT_COMMIT)));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetDatabaseMajorVersion() {
        enter();
        try {
            println(String.valueOf(_dmd.getDatabaseMajorVersion()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetDatabaseMinorVersion() {
        enter();
        try {
            println(String.valueOf(_dmd.getDatabaseMinorVersion()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetSQLStateType() {
        enter();
        try {
            println(String.valueOf(_dmd.getSQLStateType()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testLocatorsUpdateCopy() {
        enter();
        try {
            println(String.valueOf(_dmd.locatorsUpdateCopy()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testSupportsStatementPooling() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsStatementPooling()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetRowIdLifetime() {
        enter();
        try {
            println(String.valueOf(_dmd.getRowIdLifetime()));
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testSupportsStoredFunctionsUsingCallSyntax() {
        enter();
        try {
            println(String.valueOf(_dmd.supportsStoredFunctionsUsingCallSyntax()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testAutoCommitFailureClosesAllResultSets() {
        enter();
        try {
            println(String.valueOf(_dmd.autoCommitFailureClosesAllResultSets()));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetClientInfoProperties() {
        enter();
        try {
            print(_dmd.getClientInfoProperties());
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetFunctions() {
        enter();
        try {
            print(_dmd.getFunctions(null, null, "%"));
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testGetFunctionColumns() {
        enter();
        try {
            print(_dmd.getFunctionColumns(null, null, "%", "%"));
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testGetPseudoColumns() {
        enter();
        try {
            print(_dmd.getPseudoColumns(null, null, "%", "%"));
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testGeneratedKeyAlwaysReturned() {
        enter();
        try {
            println(String.valueOf(_dmd.generatedKeyAlwaysReturned()));
        } catch (SQLFeatureNotSupportedException sfnse) {
            System.out.println(EU.getExceptionMessage(sfnse));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
