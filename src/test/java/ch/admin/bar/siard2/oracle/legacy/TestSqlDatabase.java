...
public class TestSqlDatabase {
    ...
    private static List<TestColumnDefinition> getListAdSimple() {
        List<TestColumnDefinition> listAdSimple = new ArrayList<>();
        listAdSimple.add(new TestColumnDefinition("TABLEID", "INTEGER", 1));
    ...
    private static List<TestColumnDefinition> getListAdComplex() {
        List<TestColumnDefinition> listAdComplex = new ArrayList<>();
        listAdComplex.add(new TestColumnDefinition("ID", "INTEGER", 1));
    ...
    public TestSqlDatabase(Connection conn) throws SQLException {
        _conn = conn;
        try {
    ...
    private void createType(QualifiedId qiType, List<TestColumnDefinition> _listAd) throws SQLException {
        ...
        if (_listAd.size() == 1) {
            ...
            List<AttributeDefinition> listAttributeDefinitions = new ArrayList<>();
            for (TestColumnDefinition tcd : _listAd) {
    ...
    private void createView(QualifiedId qiView, List<TestColumnDefinition> listCd, QualifiedId qiTable) throws SQLException {
        ...
        tp.initialize(qiTable, new Identifier(), new ArrayList<>(), null, false, null, false, false, null, null, false, false);
        ...
        qeb.initialize(null, null, null, null, false, new ArrayList<>(), null, qs, new QualifiedId(), new ArrayList<>());
    ...
    private ValueExpression getValueExpression(TestColumnDefinition tcd, List<TestColumnDefinition> listLobs) throws SQLException {
        ...
        if ((o instanceof String) || (o instanceof byte[]) || (o instanceof Boolean) || (o instanceof Date) || (o instanceof Time) || (o instanceof Timestamp) || (o instanceof Interval))
        ...
        if (o instanceof String) {
            ...
            try {
                QualifiedId qiType = new QualifiedId(tcd.getType());
                @SuppressWarnings("unchecked") List<TestColumnDefinition> listAd = (List<TestColumnDefinition>) o;
