...
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.AttributeDetailsForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.ColumnDetailsForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.MetadataDetailsForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.ParameterOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.PrivilegesOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.RoutineOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.RoutinesOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.RowsOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.SchemaOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.TableOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.TypeDetailsForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.TypesOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.UsersOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.ViewOverviewForm;
import ch.admin.bar.siardsuite.presenter.archive.browser.forms.ViewsOverviewForm;
