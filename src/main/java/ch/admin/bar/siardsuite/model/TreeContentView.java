...
public enum TreeContentView {
     ...
     */
    ROOT("fxml/tree/content-root.fxml", "tableContainer.title.siardFile", null, null, false), SCHEMAS(
            "fxml/tree/content-root.fxml",
            "tableContainer.title.schemas",
            null,
            null,
            false), SCHEMA("fxml/tree/table.fxml",
                           "tableContainer.title.schema",
                           "tableContainer.labelSchema",
                           "tableContainer.labelDescSchema",
                           false), TABLES("fxml/tree/table.fxml",
                                          "tableContainer.title.tables",
                                          "tableContainer.labelSchema",
                                          "tableContainer.labelDescSchema",
                                          false), TABLE("fxml/tree/table.fxml",
                                                        "tableContainer.title.table",
                                                        "tableContainer.labelTable",
                                                        "tableContainer.labelNumberOfRows",
                                                        true), VIEWS("fxml/tree/table.fxml",
                                                                     "tableContainer.title.views",
                                                                     "tableContainer.labelSchema",
                                                                     "tableContainer.labelDescSchema",
                                                                     false), VIEW("fxml/tree/table.fxml",
                                                                                  "tableContainer.title.view",
                                                                                  "tableContainer.labelView",
                                                                                  "tableContainer.labelNumberOfRows",
                                                                                  true), COLUMNS("fxml/tree/table.fxml",
                                                                                                 "tableContainer.title.columns",
                                                                                                 "tableContainer.labelTable",
                                                                                                 "tableContainer.labelNumberOfRows",
                                                                                                 true), COLUMN(
            "fxml/tree/column.fxml",
    ...
    PRIVILIGES("fxml/tree/table.fxml",
               ...
               "tableContainer.labelNumberOfRows",
               false), ROUTINES("fxml/tree/table.fxml",
                                "tableContainer.title.routines",
                                "tableContainer.labelSchema",
                                "tableContainer.labelDescSchema",
                                false), ROUTINE("fxml/tree/table.fxml",
                                                "tableContainer.title.routine",
                                                "tableContainer.labelRoutine",
                                                "tableContainer.labelNumberOfRows",
                                                true), PARAMETER("fxml/tree/parameter.fxml",
