...
import ch.enterag.utils.jdbc.BaseClob;
...
public class PostgresClob
    ...
    public int setString(long pos, String str, int offset, int len)
        ...
        try {
            ...
            throw new SQLException("Setting a string in PostgresClob failed (" + EU.getExceptionMessage(ie) + ")!");
        }
        return iWritten;
    }
    ...
    public Writer setCharacterStream(long pos) throws SQLException {
        ...
        try {
            ...
            throw new SQLException("CharacterStream could not be positioned for writing in PostgresClob (" + EU.getExceptionMessage(ie) + ")!");
        }
        return wr;
    }
    ...
    public void truncate(long len) throws SQLException {
        try {
            ...
            throw new SQLException("CharacterStream could not be positioned for truncation in PostgresClob (" + EU.getExceptionMessage(ie) + ")!");
        }
    }
