...
import ch.admin.bar.siard2.postgres.PostgresObject;
    ...
    public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
        ...
        try {
            ...
            try {
                ...
                throw new SQLException("Error parsing string (" + EU.getExceptionMessage(pe) + ")!");
            }
        }
        return bd;
    }
    ...
    public void updateObject(int columnIndex, Object x)
        ...
        if (iType == Types.CLOB)
            ...
            try {
                ...
                throw new SQLException("PostgresObject could not be constructed (" + EU.getExceptionMessage(pe) + ")!");
            }
        } else if (iType == Types.DISTINCT) {
