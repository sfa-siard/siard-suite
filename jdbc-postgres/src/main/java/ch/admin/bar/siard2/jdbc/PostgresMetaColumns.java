...
public class PostgresMetaColumns
    ...
    private String getTypeName(String sTypeName, int iType)
        ...
        if (iType == Types.ARRAY) {
            ...
            try {
                ...
                if (PostgresType.INTERVAL.getKeyword()
                                         .equals(sTypeName)) {
                ...
                throw new SQLException("Parsing of " + sTypeName + " failed (" + EU.getExceptionMessage(pe) + ")!");
            }
        }
        return sTypeName;
    }
    ...
    private int getDataType(int iType, String sTypeName)
        ...
        if (pgt != null) {
            ...
            if (pt != null)
                iType = pt.getSqlType();
            if ((iType == Types.OTHER) && (PostgresType.INTERVAL.getKeyword()
                                                                .equals(sTypeName))) {
                ColumnIdentifier columnIdentifier = new ColumnIdentifier(this);
