...
public class PostgresPreparedStatement
    ...
    public void setAsciiStream(int parameterIndex, InputStream x)
            throws SQLException {
        try {
            setCharacterStream(parameterIndex, new InputStreamReader(x, "ASCII"));
    ...
    public void setAsciiStream(int parameterIndex, InputStream x,
        ...
        try {
            setCharacterStream(parameterIndex, new InputStreamReader(x, "ASCII"), length);
        } catch (UnsupportedEncodingException uee) {
        }
    }
    ...
    public void setUnicodeStream(int parameterIndex, InputStream x,
                                 int length) throws SQLException {
        try {
            setCharacterStream(parameterIndex, new InputStreamReader(x, "UTF-8"), length);
        } catch (UnsupportedEncodingException uee) {
        }
    }
    ...
    private long createClob(int parameterIndex, Reader reader)
        ...
        try {
            ...
            throw new SQLException("Reading CharacterStream failed" + EU.getExceptionMessage(ie) + "!");
        }
        return lLength;
    }
    ...
    public void setCharacterStream(int parameterIndex, Reader reader)
        ...
        if (!PostgresType.CLOB.getKeyword()
                              .equals(pmd.getParameterTypeName(parameterIndex)))
    ...
    public void setBinaryStream(int parameterIndex, InputStream x)
            throws SQLException {
        ParameterMetaData pmd = _pstmtWrapped.getParameterMetaData();
        if (!PostgresType.BLOB.getKeyword()
                              .equals(pmd.getParameterTypeName(parameterIndex)))
