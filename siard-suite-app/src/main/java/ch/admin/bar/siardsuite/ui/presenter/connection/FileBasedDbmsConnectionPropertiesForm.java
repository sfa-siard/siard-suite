...
import ch.admin.bar.siardsuite.ui.presenter.connection.fields.FileChooserFormField;
...
public class FileBasedDbmsConnectionPropertiesForm extends ConnectionPropertiesForm {
    ...
    public FileBasedDbmsConnectionPropertiesForm(
        ...
        fileChooserField = FileChooserFormField.builder()
                                               ...
                                               .initialValue(initialValue.map(FileBasedDbmsConnectionProperties::getFile)
                                                                         .orElse(null)) // FIXME
                                               .prompt(DisplayableText.of(dbms.getExampleFile()
                                                                              .getAbsolutePath()))
                                               ...
                                               .build();
        setMargin(fileChooserField, new Insets(25));
        ...
        jdbcUrl = StringFormField.builder()
                                 ...
                                 .prompt(DisplayableText.of(dbms.getJdbcConnectionStringEncoder()
                                                                .apply(FileBasedDbmsConnectionProperties.builder()
                                 ...
                                 .build();
        setMargin(jdbcUrl, new Insets(25));

        this.getChildren()
            .addAll(fileChooserField, jdbcUrl);
    ...
    private void handleJdbcUrl() {
        if (fileChooserField.hasValidValue()) {
            ...
            val currentJdbcUrl = dbms.getJdbcConnectionStringEncoder()
        ...
        return Validator.<String>builder()
                        ...
                        .isValidCheck(nullableValue -> Optional.ofNullable(nullableValue)
                                                               .filter(value -> {
                                                                   ...
                                                                   try {
                                                                       dbms.getJdbcConnectionStringDecoder()
                                                                           .apply(value);
                                                                       return true;
                                                                   } catch (Exception e) {
                                                                       return false;
