...
public class Db2ResultSetMetaData
    ...
    private class MetaData {
        ...
        public void setCatalogName(String sCatalogName) {
            _sCatalogName = sCatalogName;
        }

        public String getCatalogName() {
            return _sCatalogName;
        }

        private String _sSchemaName = null;

        public void setSchemaName(String sSchemaName) {
        ...
        public void setColumnLabel(String sColumnLabel) {
            _sColumnLabel = sColumnLabel;
        }

        public String getColumnLabel() {
            return _sColumnLabel;
        }

        private int _iColumnType = Types.NULL;

        public void setColumnType(int iColumnType) {
            _iColumnType = iColumnType;
        }
        ...
        public void setColumnTypeName(String sColumnTypeName) {
            _sColumnTypeName = sColumnTypeName;
        }

        public String getColumnTypeName() {
            return _sColumnTypeName;
        }

        private String _sColumnClassName = null;

        public void setColumnClassName(String sColumnClassName) {
            _sColumnClassName = sColumnClassName;
        }

        public String getColumnClassName() {
            return _sColumnClassName;
        }

        private int _iColumnDisplaySize = -1;

        public void setColumnDisplaySize(int iColumnDisplaySize) {
            _iColumnDisplaySize = iColumnDisplaySize;
        }

        public int getColumnDisplaySize() {
            return _iColumnDisplaySize;
        }
        ...
        public void setDefinitelyWritable(boolean bDefinitelyWritable) {
            _bDefinitelyWritable = bDefinitelyWritable;
        }

        public boolean isDefinitelyWritable() {
            return _bDefinitelyWritable;
        }

        private int _iNullable = ResultSetMetaData.columnNullableUnknown;

        public void setNullable(int iNullable) {
            _iNullable = iNullable;
        }
    ...
    private MetaData getMetaData(int iColumn)
        ...
        md.setSchemaName(super.getSchemaName(iColumn)
                              .trim());
    ...
    private Set<QualifiedId> getAttrTypes(Connection conn, Set<QualifiedId> setTypesMatching,
        ...
        try {
            ...
            throw new SQLException("Type name \"" + sAttrTypeName + "\" could not be parsed!", pe);
        } finally {
            rs.close();
        }
        return setTypes;
    ...
    private Set<QualifiedId> getStructTypes(Connection conn, List<MetaData> listStruct, String sPrefix)
        ...
        for (int iAttr = 0; iAttr < listStruct.size(); iAttr++) {
            ...
            String sAttrName = md.getColumnLabel()
            ...
            if (iPeriod < 0)
                ...
                for (; (iAttr < listStruct.size() && listStruct.get(iAttr)
                                                               .getColumnLabel()
                                                               .startsWith(sAttrPrefix)); iAttr++)
        ...
        for (int iColumn = 1; iColumn <= super.getColumnCount(); iColumn++) {
            ...
            if (iPeriod < 0)
                ...
                if (qiType != null) {
                    ...
                    while (md.getColumnLabel()
                             .startsWith(sPrefix) && (iColumn <= super.getColumnCount())) {
