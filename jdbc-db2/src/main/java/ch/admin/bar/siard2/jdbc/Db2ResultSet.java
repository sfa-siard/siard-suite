...
import ch.admin.bar.siard2.db2.Db2Literals;
...
public class Db2ResultSet
    ...
    private Struct getStruct(int iColumn, String sTypeName)
        ...
        try {
            ...
            Db2DatabaseMetaData dmd = (Db2DatabaseMetaData) getStatement().getConnection()
                                                                          .getMetaData();
            ...
            rs.close();
            struct = getStatement().getConnection()
                                   .createStruct(sTypeName, listAttributes.toArray());
        ...
        for (int iValue = 0; iValue < _listValues.size(); iValue++) {
            ...
            if (oValue instanceof Struct) {
                ...
                if ((iv.getYears() != 0) || (iv.getMonths() != 0)) {
                    ...
                    biNanos = biNanos.multiply(BigInteger.valueOf(24))
                                     .add(BigInteger.valueOf(iv.getHours()));
                    biNanos = biNanos.multiply(BigInteger.valueOf(60))
                                     .add(BigInteger.valueOf(iv.getMinutes()));
                    biNanos = biNanos.multiply(BigInteger.valueOf(60))
                                     .add(BigInteger.valueOf(iv.getSeconds()));
                    biNanos = biNanos.multiply(BigInteger.valueOf(1000000000))
                                     .add(BigInteger.valueOf(iv.getNanoSeconds()));
    ...
    private String formatStructValue(Struct struct, List<Object> listLobs)
        ...
        try {
            ...
            throw new SQLException("Type " + struct.getSQLTypeName() + " could not be parsed!");
        }
    ...
    private void insertRecord()
        ...
        PreparedStatement pstmt = getStatement().getConnection()
    ...
    private void printState()
        ...
        switch (super.getConcurrency()) {
            case ResultSet.CONCUR_READ_ONLY:
                s = s + "CONCUR_READ_ONLY";
                break;
            case ResultSet.CONCUR_UPDATABLE:
                s = s + "CONCUR_UPDATABLE";
                break;
        }
        s = s + ", ";
        switch (super.getHoldability()) {
            case ResultSet.HOLD_CURSORS_OVER_COMMIT:
                s = s + "HOLD_CURSORS_OVER_COMMIT";
                break;
            case ResultSet.CLOSE_CURSORS_AT_COMMIT:
                s = s + "CLOSE_CURSORS_OVER_COMMIT";
                break;
        }
    ...
    private int getDataType(int columnIndex)
        ...
        if (iDataType == Types.DISTINCT) {
            ...
            try {
                ...
                throw new SQLException("DISTINCT type " + sTypeName + " could not be parsed!");
            }
        }
        return iDataType;
    }
    ...
    public boolean getBoolean(int columnIndex) throws SQLException {
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                case Types.SMALLINT:
                    b = ((Short) o).shortValue() != 0;
                    break;
                case Types.INTEGER:
                    b = ((Integer) o).intValue() != 0;
                    break;
                case Types.BIGINT:
                    b = ((Long) o).longValue() != 0;
                    break;
                case Types.REAL:
                    b = ((Float) o).floatValue() != 0.0;
                    break;
                case Types.FLOAT:
                case Types.DOUBLE:
                    b = ((Double) o).doubleValue() != 0.0;
                    break;
                case Types.NUMERIC:
                case Types.DECIMAL:
                    b = !((BigDecimal) o).equals(BigDecimal.ZERO);
                    break;
                case Types.BOOLEAN:
    ...
    public void updateBoolean(int columnIndex, boolean x)
        ...
        switch (iDataType) {
            case Types.SMALLINT:
                o = Short.valueOf(x ? (short) 1 : (short) 0);
                break;
            case Types.INTEGER:
                o = Integer.valueOf(x ? 1 : 0);
                break;
            case Types.BIGINT:
                o = Long.valueOf(x ? 1l : 0l);
                break;
            case Types.REAL:
                o = Float.valueOf(x ? 1.0f : 0.0f);
                break;
            case Types.FLOAT:
            case Types.DOUBLE:
                o = Double.valueOf(x ? 1.0 : 0.0);
                break;
            case Types.NUMERIC:
            case Types.DECIMAL:
                o = x ? BigDecimal.ONE : BigDecimal.ZERO;
                break;
            case Types.BOOLEAN:
                o = Boolean.valueOf(x);
                break;
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                ...
                case Types.BIGINT:
                    ...
                    break;
                case Types.REAL:
                    by = ((Float) o).byteValue();
                    break;
                case Types.FLOAT:
                case Types.DOUBLE:
                    by = ((Double) o).byteValue();
                    break;
                case Types.NUMERIC:
                case Types.DECIMAL:
                    by = ((BigDecimal) o).byteValue();
                    break;
                case Types.BOOLEAN:
                    by = ((Boolean) o).booleanValue() ? (byte) 1 : (byte) 0;
                    break;
                case Types.CHAR:
                case Types.VARCHAR:
                    by = Byte.parseByte((String) o);
                    break;
                default:
    ...
    public void updateByte(int columnIndex, byte x) throws SQLException {
        ...
        switch (iDataType) {
            case Types.SMALLINT:
                o = Short.valueOf(by.shortValue());
                break;
            case Types.INTEGER:
                o = Integer.valueOf(by.intValue());
                break;
            case Types.BIGINT:
                o = Long.valueOf(by.longValue());
                break;
            case Types.REAL:
                o = Float.valueOf(by.floatValue());
                break;
            case Types.FLOAT:
            case Types.DOUBLE:
                o = Double.valueOf(by.doubleValue());
                break;
            case Types.NUMERIC:
            case Types.DECIMAL:
                o = BigDecimal.valueOf(by.longValue());
                break;
            case Types.BOOLEAN:
                o = Boolean.valueOf(by.intValue() != 0);
                break;
            case Types.CHAR:
            case Types.VARCHAR:
                o = String.valueOf(x);
    ...
    public short getShort(int columnIndex) throws SQLException {
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                case Types.SMALLINT:
                    sh = ((Short) o).shortValue();
                    break;
                case Types.INTEGER:
                    sh = ((Integer) o).shortValue();
                    break;
                case Types.BIGINT:
                    sh = ((Long) o).shortValue();
                    break;
                case Types.REAL:
                    sh = ((Float) o).shortValue();
                    break;
                case Types.FLOAT:
                case Types.DOUBLE:
                    sh = ((Double) o).shortValue();
                    break;
                case Types.NUMERIC:
                case Types.DECIMAL:
                    sh = ((BigDecimal) o).shortValue();
                    break;
                case Types.BOOLEAN:
                    sh = ((Boolean) o).booleanValue() ? (short) 1 : (short) 0;
                    break;
                case Types.CHAR:
                case Types.VARCHAR:
                    sh = Short.parseShort((String) o);
                    break;
                default:
    ...
    public void updateShort(int columnIndex, short x) throws SQLException {
        ...
        switch (iDataType) {
            case Types.SMALLINT:
                ...
                break;
            case Types.INTEGER:
                o = Integer.valueOf(sh.intValue());
                break;
            case Types.BIGINT:
                o = Long.valueOf(sh.longValue());
                break;
            case Types.REAL:
                o = Float.valueOf(sh.floatValue());
                break;
            case Types.FLOAT:
            case Types.DOUBLE:
                o = Double.valueOf(sh.doubleValue());
                break;
            case Types.NUMERIC:
            case Types.DECIMAL:
                o = BigDecimal.valueOf(sh.longValue());
                break;
            case Types.BOOLEAN:
                o = Boolean.valueOf(x != 0);
                break;
            case Types.CHAR:
            case Types.VARCHAR:
                o = String.valueOf(x);
    ...
    public void updateInt(int columnIndex, int x) throws SQLException {
        ...
        switch (iDataType) {
            case Types.SMALLINT:
                o = Short.valueOf(i.shortValue());
                break;
            case Types.INTEGER:
                o = i;
                break;
            case Types.BIGINT:
                o = Long.valueOf(i.longValue());
                break;
            case Types.REAL:
                o = Float.valueOf(i.floatValue());
                break;
            case Types.FLOAT:
            case Types.DOUBLE:
                o = Double.valueOf(i.doubleValue());
                break;
            case Types.NUMERIC:
            case Types.DECIMAL:
                o = BigDecimal.valueOf(x);
                break;
            case Types.BOOLEAN:
                o = Boolean.valueOf(x != 0);
                break;
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                ...
                case Types.DECIMAL:
                    ...
                    break;
                case Types.BOOLEAN:
                    l = ((Boolean) o).booleanValue() ? 1l : 0l;
                    break;
                case Types.CHAR:
                case Types.VARCHAR:
    ...
    public void updateLong(int columnIndex, long x) throws SQLException {
        ...
        switch (iDataType) {
            case Types.SMALLINT:
                o = Short.valueOf(l.shortValue());
                break;
            case Types.INTEGER:
                o = Integer.valueOf(l.intValue());
                break;
            case Types.BIGINT:
                o = l;
                break;
            case Types.REAL:
                o = Float.valueOf(l.floatValue());
                break;
            case Types.FLOAT:
            case Types.DOUBLE:
                o = Double.valueOf(l.doubleValue());
                break;
            case Types.NUMERIC:
            case Types.DECIMAL:
                o = BigDecimal.valueOf(x);
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                ...
                case Types.DECIMAL:
                    ...
                    break;
                case Types.BOOLEAN:
                    f = ((Boolean) o).booleanValue() ? 1.0f : 0.0f;
                    break;
                case Types.CHAR:
                case Types.VARCHAR:
    ...
    public void updateFloat(int columnIndex, float x) throws SQLException {
        ...
        switch (iDataType) {
            case Types.SMALLINT:
                o = Short.valueOf(f.shortValue());
                break;
            case Types.INTEGER:
                o = Integer.valueOf(f.intValue());
                break;
            case Types.BIGINT:
                o = Long.valueOf(f.longValue());
                break;
            case Types.REAL:
                o = f;
                break;
            case Types.FLOAT:
            case Types.DOUBLE:
                o = Double.valueOf(f.doubleValue());
                break;
            case Types.NUMERIC:
            case Types.DECIMAL:
                o = BigDecimal.valueOf(f.doubleValue());
                break;
            case Types.BOOLEAN:
                o = Boolean.valueOf(x != 0.0f);
                break;
            case Types.CHAR:
            case Types.VARCHAR:
                o = String.valueOf(x);
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                ...
                case Types.DECIMAL:
                    ...
                    break;
                case Types.BOOLEAN:
                    d = ((Boolean) o).booleanValue() ? 1.0 : 0.0;
                    break;
                case Types.CHAR:
                case Types.VARCHAR:
    ...
    public void updateDouble(int columnIndex, double x) throws SQLException {
        ...
        switch (iDataType) {
            case Types.SMALLINT:
                o = Short.valueOf(d.shortValue());
                break;
            case Types.INTEGER:
                o = Integer.valueOf(d.intValue());
                break;
            case Types.BIGINT:
                o = Long.valueOf(d.longValue());
                break;
            case Types.REAL:
                o = Float.valueOf(d.floatValue());
                break;
            case Types.FLOAT:
            case Types.DOUBLE:
                o = d;
    ...
    public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                case Types.SMALLINT:
                    bd = new BigDecimal(((Short) o).intValue());
                    break;
                case Types.INTEGER:
                    bd = new BigDecimal(((Integer) o).intValue());
                    break;
                case Types.BIGINT:
                    bd = new BigDecimal(((Long) o).longValue());
                    break;
                case Types.REAL:
                    bd = new BigDecimal(((Float) o).doubleValue());
                    break;
                case Types.FLOAT:
                case Types.DOUBLE:
                    bd = new BigDecimal(((Double) o).doubleValue());
                    break;
                case Types.NUMERIC:
                case Types.DECIMAL:
                    bd = (BigDecimal) o;
                    break;
                case Types.BOOLEAN:
                    bd = ((Boolean) o).booleanValue() ? BigDecimal.ONE : BigDecimal.ZERO;
                    break;
                case Types.CHAR:
                case Types.VARCHAR:
    ...
    public void updateBigDecimal(int columnIndex, BigDecimal x) throws SQLException {
        ...
        if (x != null) {
            ...
            switch (iDataType) {
                case Types.SMALLINT:
                    o = Short.valueOf(x.shortValue());
                    break;
                case Types.INTEGER:
                    o = Integer.valueOf(x.intValue());
                    break;
                case Types.BIGINT:
                    o = Long.valueOf(x.longValue());
                    break;
                case Types.REAL:
                    o = Float.valueOf(x.floatValue());
                    break;
                case Types.FLOAT:
                case Types.DOUBLE:
                    o = Double.valueOf(x.doubleValue());
                    break;
                case Types.NUMERIC:
                case Types.DECIMAL:
                    o = x;
                    break;
                case Types.BOOLEAN:
                    o = Boolean.valueOf(!BigDecimal.ZERO.equals(x));
                    break;
                case Types.CHAR:
                case Types.VARCHAR:
                    o = x.toPlainString();
            ...
            switch (iDataType) {
                ...
                case Types.VARBINARY:
                    try {
                        ...
                        throw new SQLException("ISO-8859-1 is an unsupported encoding!", uee);
                    }
                    break;
                case Types.CLOB:
                case Types.NCLOB:
    ...
    public void updateString(int columnIndex, String x)
        ...
        if (x != null) {
            ...
            switch (iDataType) {
                case Types.SMALLINT:
                    o = Short.valueOf(Short.parseShort(x));
                    break;
                case Types.INTEGER:
                    o = Integer.valueOf(Integer.parseInt(x));
                    break;
                case Types.BIGINT:
                    o = Long.valueOf(Long.parseLong(x));
                    break;
                case Types.REAL:
                    o = Float.valueOf(Float.parseFloat(x));
                    break;
                case Types.FLOAT:
                case Types.DOUBLE:
                    o = Double.valueOf(Double.parseDouble(x));
                    break;
                case Types.NUMERIC:
                case Types.DECIMAL:
                    o = new BigDecimal(x);
                ...
                case Types.NCLOB:
                    ...
                    break;
                case Types.SQLXML:
                    SQLXML sqlxml = getStatement().getConnection()
                                                  .createSQLXML();
                    sqlxml.setString(x);
                    o = sqlxml;
                    break;
        ...
        if (x != null) {
            ...
            switch (iDataType) {
                ...
                case Types.VARBINARY:
                    ...
                    break;
                case Types.BLOB:
                    Blob blob = getStatement().getConnection()
                                              .createBlob();
                    blob.setBytes(1l, x);
                    o = blob;
                    break;
        ...
        if (x != null) {
            ...
            switch (iDataType) {
                case Types.DATE:
                    ...
                    break;
                case Types.TIME:
                    o = new Time(x.getTime() % _lMILLIS_PER_DAY);
                    break;
                case Types.TIMESTAMP:
                    o = new Timestamp(x.getTime());
                    break;
                default:
    ...
    public Time getTime(int columnIndex) throws SQLException {
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                case Types.DATE:
                    time = new Time(((Date) o).getTime() % _lMILLIS_PER_DAY);
                    break;
                case Types.TIME:
                    time = (Time) o;
                    break;
                case Types.TIMESTAMP:
                    time = new Time(((Timestamp) o).getTime() % _lMILLIS_PER_DAY);
                    break;
                default:
    ...
    public Timestamp getTimestamp(int columnIndex) throws SQLException {
        ...
        if (o != null) {
            ...
            switch (iDataType) {
                case Types.DATE:
                    ts = new Timestamp(((Date) o).getTime());
                    break;
                case Types.TIME:
                    ts = new Timestamp(((Time) o).getTime());
                    break;
                case Types.TIMESTAMP:
                    ts = (Timestamp) o;
                    break;
    ...
    public void updateAsciiStream(int columnIndex, InputStream x, long length)
        ...
        if (x != null) {
            ...
            try {
                ...
                throw new SQLException("I/O error reading ASCII stream!", ie);
            }
        }
        updateObject(columnIndex, o);
    }
    ...
    public void updateCharacterStream(int columnIndex, Reader x, long length)
        ...
        if (x != null) {
            ...
            try {
                ...
                throw new SQLException("I/O error reading character stream!", ie);
            }
        }
        updateObject(columnIndex, o);
    }
    ...
    public void updateNClob(int columnIndex, Reader reader, long length)
        ...
        if (reader != null) {
            ...
            try {
                switch (iDataType) {
                    case Types.NCLOB:
                        NClob nclob = getStatement().getConnection()
                                                    .createNClob();
