...
public class Db2DatabaseMetaData
    ...
    public ResultSet getUDTs(String catalog, String schemaPattern,
        ...
        for (Iterator<String> iterClass = mapClass.keySet()
                                                  .iterator(); iterClass.hasNext(); ) {
            String sTypeName = iterClass.next();
            String sClassName = mapClass.get(sTypeName)
                                        .getName();
        ...
        for (Iterator<String> iterDataType = mapDataType.keySet()
                                                        .iterator(); iterDataType.hasNext(); ) {
        ...
        sbSql.append(sbCondition.toString());
        Statement stmt = getConnection().unwrap(Connection.class)
                                        .createStatement();
