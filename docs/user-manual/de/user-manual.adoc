...
ein Java Runtime Environment 8 (JRE) mit der JavaFX Extension
installiert ist.
...
bereitgestellte Distribution verwendet werden. Es steht keine Distribution mit inkludierter Runtime zur Verfügung. Entsprechend muss eine JRE v8 mit Java FX Erweiterung auf dem System installiert sein. Entsprechende Distributionen sind u.a. hier erhältlich:

https://www.azul.com/downloads/?package=jdk-fx#download-openjdk

https://aws.amazon.com/correto

Die heruntergeladenen ZIP-Archive können an einem beliebigen Ort entpackt werden und dann mittels der entsprechenden Startskripte ausgeführt werden:
