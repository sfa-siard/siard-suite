...
L'applicazione SIARD Suite è un'applicazione Java FX. Come tale, può essere eseguita su qualsiasi sistema su cui sia installato un Java Runtime Environment (JRE) 17 con l'estensione JavaFX.
