...
Ce document donne un bref aperçu de l'application et de son utilisation. Un manuel détaillé en anglais est disponible sur le site du projet des Archives fédérales suisses : https://www.bar.admin.ch/bar/fr/home/archivage/outils-et-instruments/siard-suite.html
