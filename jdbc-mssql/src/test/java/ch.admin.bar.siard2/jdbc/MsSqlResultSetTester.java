                ...
                if (tcd.getName()
                    ...
                    if (o instanceof String) {
                        ...
                        fail("Type String expected for " + tcd.getType() + "!");
                              ...
                              .equals(TestSqlDatabase.COLUMN_DATALINK)) {
                    if (!(o instanceof Blob)) {
                        fail("Type Blob expected for " + tcd.getType() + "!");
                    }
                } else {
                ...
                if (tcd.getName()
                    ...
                    if (o instanceof String) {
                        ...
                        fail("Type String expected for " + tcd.getType() + "!");
                              ...
                              .equals("CDATETIMEOFFSET_5")) {
                    System.out.println(tcd.getName() + ": " + o.getClass()
                                                               .getName());
                } else if (tcd.getName()
                              .equals("CUNIQUEIDENTIFIER")) {
                    if (o instanceof String) {
                        String s = (String) o;
                    ...
                    if (o instanceof String) {
                        ...
                        fail("Type String expected for " + tcd.getType() + "!");
                              ...
                              .equals("CVARCHAR_64") ||
                        tcd.getName()
                           .equals("CNVARCHAR_1000") ||
                        tcd.getName()
                           .equals("CNVARCHAR_MAX") ||
                        tcd.getName()
                           .equals("CSYSNAME")) {
                    if (o instanceof String) {
                        String s = (String) o;
