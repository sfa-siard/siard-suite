...
public class MsSqlResultSet
    ...
    public String getCursorName() throws SQLException {
        ...
        try {
            sCursorName = super.getCursorName();
    ...
    public int findColumn(String columnLabel) throws SQLException {
        int i = 0;
        try {
            i = super.findColumn(columnLabel);
        } catch (SQLServerException sse) {
    ...
    public boolean getBoolean(int columnIndex) throws SQLException {
        boolean b = false;
        try {
            b = super.getBoolean(columnIndex);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return b;
    ...
    public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
        ...
        try {
            bd = super.getBigDecimal(columnIndex);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return bd;
    ...
    public BigDecimal getBigDecimal(int columnIndex, int scale)
        ...
        BigDecimal bd = BigDecimal.ZERO;
        try {
            bd = super.getBigDecimal(columnIndex, scale);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return bd;
    ...
    public Date getDate(int columnIndex) throws SQLException {
        Date date = null;
        try {
            date = super.getDate(columnIndex);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return date;
    ...
    public Date getDate(int columnIndex, Calendar cal)
        ...
        Date date = null;
        try {
            date = super.getDate(columnIndex, cal);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return date;
    ...
    public Time getTime(int columnIndex) throws SQLException {
        Time time = null;
        try {
            time = super.getTime(columnIndex);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return time;
    ...
    public Time getTime(int columnIndex, Calendar cal)
        ...
        Time time = null;
        try {
            time = super.getTime(columnIndex, cal);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return time;
    ...
    public Timestamp getTimestamp(int columnIndex) throws SQLException {
        Timestamp ts = null;
        try {
            ts = super.getTimestamp(columnIndex);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return ts;
    ...
    public Timestamp getTimestamp(int columnIndex, Calendar cal)
        ...
        Timestamp ts = null;
        try {
            ts = super.getTimestamp(columnIndex, cal);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return ts;
    ...
    public InputStream getAsciiStream(int columnIndex)
        ...
        InputStream is = null;
        try {
            is = super.getAsciiStream(columnIndex);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return is;
    ...
    public InputStream getUnicodeStream(int columnIndex)
        ...
        InputStream is = null;
        try {
            is = super.getUnicodeStream(columnIndex);
        } catch (SQLServerException sse) {
            throwNotSupportedException(sse);
        }
        return is;
    ...
    public Reader getCharacterStream(int columnIndex) throws SQLException {
        Reader rdr = null;
        try {
            rdr = super.getCharacterStream(columnIndex);
        } catch (SQLServerException sse) {
            throwSqlException(sse);
        }
        return rdr;
